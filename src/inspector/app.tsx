...
export function InspectorApp() {
  ...
  const generateRoom = useCallback(() => {
    ...
    const doorId = prompt(`Door entity ID for the new room:\n${choices}`, doors[0]!.id); if (doorId == null) return;
    ...
    const direction = prompt('Direction from the door (for example: north, east, up)', ''); if (direction == null) return;
    void generateEntity('room', door.id, direction.trim());
