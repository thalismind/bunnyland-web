...
export function InspectorApp() {
  ...
  const disconnect = useCallback(() => { if (refreshRef.current != null) clearTimeout(refreshRef.current); wsRef.current?.close(); wsRef.current = null; setStatus({ className: '', text: '○ Offline' }); setRuntime({ paused: null, running: false }); syncUrl(); }, [syncUrl]);
